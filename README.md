...
| appium:appWorkingDir               | Full path to the folder, which is going to be set as the working dir for the application under test. This is only applicable for classic apps. When this is used the `appium:app` does not need to contain the path and can just contain executable filename.                                                                     | `C:\MyApp\`                                                                        |
